...
- Where the household lives is housing, even when it is an Airbnb or a short-term flat and its extensions while settling in a city; a hotel on a holiday trip is Leisure & Travel. Airline baggage or overweight fees, exit tolls and airport transfers are Transport. A cafe chain such as Starbucks is Eating Out even when the receipt includes packaged coffee.
